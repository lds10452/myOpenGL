...
int main()
{
	...
	float vertices[] = 
	{
		...
		-0.0,-1.0, 0.0f, 0.0, 0.0f,   // 左下
		-0.0, 1.0, 0.0f, 0.0, 1.0f,   // 左上
		0.0,   1.0f, 0.0f, 1.0, 1.0f,   // 右上
		0.0,  -1.0, 0.0f, 1.0, 0.0f,   // 右下
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		vertices[3]=offset;
		vertices[8]=offset;
		vertices[10]=-1.0+2*offset;
		vertices[13]=offset;
		vertices[15]=-1.0+2*offset;
		vertices[18]=offset;

		vertices[20]=-1.0+2*offset;
		vertices[23]=offset;
		vertices[25]=-1.0+2*offset;
		vertices[28]=offset;
		glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
