...
int main()
{
	...
	float vertices[] = 
	{
		...
		0.0f,0.0f, 0.0f, 0.5, 0.5f,   // 右上
		0.5,  -0.5f, 0.0f, 1.0, 0.0f,   // 右下
		-0.5f,-0.5f, 0.0f, 0.0, 0.0f,   // 左下
		0.0f,0.0f, 0.0f, 0.5, 0.5f,   // 左上

		0.0f,0.0f, 0.0f, 0.5, 0.5f,   // 右上
		0.0f,0.0f, 0.0f, 0.5, 0.5f,   // 右下
		-0.5f,-0.5f, 0.0f, 0.0, 0.0f,   // 左下
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		vertices[25]=temp;//2
		vertices[26]=-temp;
		vertices[28]=0.5+temp;
		vertices[29]=0.5-temp;

		vertices[30]=-temp;
		vertices[31]=-temp;
		vertices[33]=0.5-temp;
		vertices[34]=0.5-temp;

		vertices[50]=-temp;//3
		vertices[51]=-temp;
		vertices[53]=0.5-temp;
		vertices[54]=0.5-temp;

		vertices[55]=-temp;
		vertices[56]=temp;
		vertices[58]=0.5-temp;
		vertices[59]=0.5+temp;

		vertices[60]=temp;//4
		vertices[61]=temp;
		vertices[63]=0.5+temp;
		vertices[64]=0.5+temp;

		vertices[75]=-temp;
		vertices[76]=temp;
		vertices[78]=0.5-temp;
		vertices[79]=0.5+temp;
		glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
