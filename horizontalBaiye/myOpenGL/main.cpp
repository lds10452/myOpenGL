...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		vertices[0]=0.25+temp;
		vertices[3]=0.75+temp;
		vertices[5]=0.25+temp;
		vertices[8]=0.75+temp;

		vertices[20]=0.0+temp;
		vertices[23]=0.5+temp;
		vertices[25]=0.0+temp;
		vertices[28]=0.5+temp;

		vertices[40]=-0.25+temp;
		vertices[43]=0.25+temp;
		vertices[45]=-0.25+temp;
		vertices[48]=0.25+temp;

		vertices[60]=-0.5+temp;
		vertices[63]=0.0+temp;
		vertices[65]=-0.5+temp;
		vertices[68]=0.0+temp;
		glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
